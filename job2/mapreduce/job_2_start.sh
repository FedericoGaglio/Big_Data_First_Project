./bin/hadoop jar ./streaming/hadoop-streaming-3.2.1.jar \
	...
	-files /Users/alessio/Documents/Universita/big-data/Big_Data_First_Project/dataset/historical_stocks.csv,/Users/alessio/Documents/Universita/big-data/Big_Data_First_Project/dataset/historical_stock_prices.csv\
